...
// SubscribeForm removed — subscribe CTA now links to Buttondown
		...
		<AppProvider publication={publication}>
			<Layout>
				...
				<Container className="flex flex-col items-stretch gap-10 px-5 pb-10">
					...
					{allPosts.length > 0 && (
						<div className="grid grid-cols-4 rounded-lg bg-amber-50 px-5 py-5 dark:bg-neutral-900 md:py-10">
							<div className="col-span-full flex flex-col items-center gap-4 md:col-span-2 md:col-start-2">
								<h2 className="text-center text-lg font-semibold text-amber-700 dark:text-amber-400">
								...
								<a
									...
									className="rounded-full bg-amber-500 px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-amber-400"
								>
									Subscribe
								</a>
							</div>
